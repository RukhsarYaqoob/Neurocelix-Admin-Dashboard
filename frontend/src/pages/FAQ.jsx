...
function FAQ() {
  ...
  return (
    <div
      className={`min-h-screen py-8 md:py-16 px-5 transition-colors duration-300 ${
    ...
    >
      <div className="max-w-4xl mx-auto">
        {/* Heading */}
        <h1
          className={`text-3xl md:text-5xl font-bold text-center pt-10 mb-14 transition-colors duration-300 ${
        ...
        <div className="space-y-6">
          {faqs
            ...
            .map((faq) => (
              <div
                key={faq._id}
                className={`rounded-2xl p-4 md:p-6 transition-all duration-300 shadow-lg ${
                  dark
