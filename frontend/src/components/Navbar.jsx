...
export default function Navbar({ dark, setDark }) {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between">
        ...
        <Link
          to="/"
          className="text-xl md:text-2xl font-extrabold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500"
        >
          Neurocelix AI
        </Link>
  ...
  transition-all duration-500 backdrop-blur-md overflow-y-auto
